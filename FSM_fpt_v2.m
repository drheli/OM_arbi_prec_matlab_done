function [u_r,wr_v_n,rd_n,enable,add_enable,res_enable,x_v_plus,x_v_minus,y_v_plus,y_v_minus] = FSM_fpt_v2(x_in_plus, x_in_minus, y_in_plus, y_in_minus)
IDLE=0;
COMP=1;
REST=2;
unrolling = 8;
...
%         end
    ...
    case COMP        
        ...
        x_plus = x_in_plus(count + unrolling);
        x_minus = x_in_minus(count+ unrolling);
        y_plus = y_in_plus(count+ unrolling);
        y_minus = y_in_minus(count+ unrolling);
